  ...
  if (submitted) {
    return (
      <div className="flex flex-col items-center justify-center gap-4 py-12">
        ...
        <p className="text-white text-xl font-medium">¡Pregunta enviada!</p>
        <p className="text-slate-400">El presentador la verá en pantalla</p>
      </div>
    )
  }
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <textarea
        ...
        rows={4}
        className="w-full px-4 py-3 rounded-xl bg-slate-800 border-2 border-slate-600 focus:border-indigo-500 text-white text-base resize-none outline-none transition-colors"
      />
      <button
